(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_02a8b457._.js", {
...
const mapObjects = [
    {
        ...
        width: 2,
        height: 2,
        sprite: "/sprites/environment/magic-portal.png"
    },
    {
        id: "fountain",
        type: "decor",
        ...
        width: 3,
        height: 3,
        sprite: "/sprites/environment/magic-fountain.png"
    },
    {
        id: "market_stall1",
        type: "shop",
        ...
        width: 2,
        height: 2,
        sprite: "/sprites/environment/market-stall.png"
    },
    {
        id: "market_stall2",
        type: "shop",
        ...
        width: 2,
        height: 2,
        sprite: "/sprites/environment/market-stall2.png"
    },
    {
        id: "blacksmith",
        type: "building",
        ...
        width: 3,
        height: 3,
        sprite: "/sprites/buildings/blacksmith.png"
    },
    {
        id: "inn",
        type: "building",
        ...
        width: 4,
        height: 4,
        sprite: "/sprites/buildings/inn.png"
    },
    {
        id: "npc1",
        type: "npc",
        ...
        width: 1,
        height: 2,
        sprite: "/sprites/characters/guild-master.png"
    },
    {
        id: "npc2",
        type: "npc",
        ...
        width: 1,
        height: 2,
        sprite: "/sprites/characters/village-merchant.png"
    },
    {
        id: "npc3",
        type: "npc",
        ...
        width: 1,
        height: 2,
        sprite: "/sprites/characters/blacksmith.png"
    },
    {
        id: "statue",
        type: "decor",
        ...
        width: 2,
        height: 3,
        sprite: "/sprites/environment/hero-statue.png"
    },
    {
        id: "chest",
        type: "treasure",
        ...
        width: 1,
        height: 1,
        sprite: "/sprites/environment/mystic-chest.png"
    }
];
function PixelVerseMap() {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PixelVerseMap.useEffect": ()=>{
            const canvas = canvasRef.current;
            const ctx = canvas.getContext("2d");
            canvas.width = MAP_WIDTH * TILE_SIZE;
            canvas.height = MAP_HEIGHT * TILE_SIZE;
            const drawMap = {
                "PixelVerseMap.useEffect.drawMap": ()=>{
                    ctx.clearRect(0, 0, canvas.width, canvas.height);
                    ctx.fillStyle = "#8B5A2B";
                    ctx.fillRect(0, 0, canvas.width, canvas.height);
                    mapObjects.forEach({
                        "PixelVerseMap.useEffect.drawMap": (obj)=>{
                            const img = new Image();
                            img.src = obj.sprite;
                            img.onload = ({
                                "PixelVerseMap.useEffect.drawMap": ()=>{
                                    ctx.drawImage(img, obj.x * TILE_SIZE, obj.y * TILE_SIZE, obj.width * TILE_SIZE, obj.height * TILE_SIZE);
                                }
                            })["PixelVerseMap.useEffect.drawMap"];
                        }
                    }["PixelVerseMap.useEffect.drawMap"]);
    ...
    const handleKeyDown = (event)=>{
        setPlayer((prev)=>{
            ...
            if (event.key === "ArrowUp") newPos.y -= 1;
            if (event.key === "ArrowDown") newPos.y += 1;
            if (event.key === "ArrowLeft") newPos.x -= 1;
            if (event.key === "ArrowRight") newPos.x += 1;
            return newPos;
        });
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PixelVerseMap.useEffect": ()=>{
            ...
            return ({
                "PixelVerseMap.useEffect": ()=>window.removeEventListener("keydown", handleKeyDown)
            })["PixelVerseMap.useEffect"];
        }
    }["PixelVerseMap.useEffect"], []);
...
_s(PixelVerseMap, "nbm7lJAW5gENFQyH4eW3kiFgOuM=");
_c = PixelVerseMap;
var _c;
__turbopack_context__.k.register(_c, "PixelVerseMap");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_02a8b457._.js.map