(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_7eedf589._.js", {
...
function Tavern() {
    ...
    // };
    const initPhaser = async ()=>{
        if ("object" === 'undefined' || phaserGame.current || !gameRef.current) return;
        try {
            ...
            class TavernScene extends Phaser.Scene {
                ...
                create() {
                    ...
                    const playerSprite = this.physics.add.sprite(this.cameras.main.width / 2, this.cameras.main.height * 0.8, 'character', 0).setScale(1.5); // Adjust sprite size
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Tavern.useEffect": ()=>{
            if ("object" !== 'undefined' && activeTab === "game") {
                setTimeout({
                    "Tavern.useEffect": ()=>initPhaser()
                }["Tavern.useEffect"], 50); // Small delay to ensure the DOM is ready
            }
        }
    }["Tavern.useEffect"], [
        activeTab
...
_s(Tavern, "1lQZF0TyZagO/Q4bvK5X/1CpMJc=");
_c = Tavern;
var _c;
...
//# sourceMappingURL=_7eedf589._.js.map