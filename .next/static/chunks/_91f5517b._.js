(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_91f5517b._.js", {
...
function TavernMap() {
    ...
    const [playerX, setPlayerX] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(350);
    const [playerY, setPlayerY] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(250);
    ...
    const [dialogContent, setDialogContent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        title: "",
        description: ""
    });
    const playerSize = 20;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TavernMap.useEffect": ()=>{
            const handleKeyDown = {
                "TavernMap.useEffect.handleKeyDown": (e)=>{
                    switch(e.key){
                        case "ArrowUp":
                            setPlayerY({
                                "TavernMap.useEffect.handleKeyDown": (prev)=>Math.max(playerSize, prev - moveSpeed)
                            }["TavernMap.useEffect.handleKeyDown"]);
                            break;
                        case "ArrowDown":
                            setPlayerY({
                                "TavernMap.useEffect.handleKeyDown": (prev)=>Math.min(window.innerHeight - 100, prev + moveSpeed)
                            }["TavernMap.useEffect.handleKeyDown"]);
                            break;
                        case "ArrowLeft":
                            setPlayerX({
                        ...
                        case "ArrowRight":
                            setPlayerX({
                                "TavernMap.useEffect.handleKeyDown": (prev)=>Math.min(window.innerWidth - 100, prev + moveSpeed)
                            }["TavernMap.useEffect.handleKeyDown"]);
                            break;
                        case "e":
            ...
            return ({
                "TavernMap.useEffect": ()=>window.removeEventListener("keydown", handleKeyDown)
            })["TavernMap.useEffect"];
        }
    }["TavernMap.useEffect"], []);
    // Draw the tavern
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TavernMap.useEffect": ()=>{
            ...
            otherParticipants.forEach({
                "TavernMap.useEffect": (participant)=>{
                    // Avatar circle
    ...
    const checkInteraction = ()=>{
        ...
        switch(nearElement.type){
            case "npc":
                if (nearElement.name === "Tavern Keeper") {
                    setDialogContent({
                        ...
                        description: "Welcome to the Golden Dragon Tavern! Feel free to take a seat at any table. We have private rooms available upstairs if you need a more secluded meeting space."
                    });
                } else {
                    setDialogContent({
                        title: `${nearElement.name} says:`,
            ...
            case "bard":
                setDialogContent({
                    title: `${nearElement.name} says:`,
                    description: "Would you like to hear a tale of adventure and wonder? Or perhaps you'd like to request a specific song for the tavern?"
                });
                setShowDialog(true);
                break;
            case "fireplace":
                setDialogContent({
                    title: `${nearElement.name}`,
                    description: "The warm fire crackles and provides a cozy atmosphere to the tavern. Perfect for sharing stories with fellow adventurers."
                });
                setShowDialog(true);
                break;
            case "bar":
                setDialogContent({
                    title: `${nearElement.name}`,
                    description: "The bar counter is stocked with various drinks and refreshments. You can order something to enjoy during your meeting."
                });
                setShowDialog(true);
                break;
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("canvas", {
                ref: canvasRef,
                className: "border border-gray-300 rounded-lg shadow-md bg-amber-50"
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute bottom-4 left-4 bg-white/80 p-2 rounded-md text-sm",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: "Press E to interact with objects and NPCs"
                    }, void 0, false, {
                        fileName: "[project]/app/components/tavern-map.tsx",
                        lineNumber: 318,
                        columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                    children: dialogContent.description
                                }, void 0, false, {
                                    fileName: "[project]/app/components/tavern-map.tsx",
                                    lineNumber: 325,
                                    columnNumber: 13
...
_s(TavernMap, "Q/YF4Is4821KXK1vbVHtOrUemTc=");
_c = TavernMap;
var _c;
__turbopack_context__.k.register(_c, "TavernMap");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_91f5517b._.js.map